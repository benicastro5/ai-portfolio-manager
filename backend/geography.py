...
ETF_GEO: dict[str, dict] = {
    ...
    "SCHD": {"continent": "North America", "regions": ["us"],                  "countries": ["us"],              "always_include": False},
    "XBI":  {"continent": "North America", "regions": ["us"],                  "countries": ["us"],              "always_include": False},
    "BOTZ": {"continent": "Global",        "regions": ["global"],              "countries": ["global"],          "always_include": False},
    "CIBR": {"continent": "North America", "regions": ["us"],                  "countries": ["us"],              "always_include": False},
    "ICLN": {"continent": "Global",        "regions": ["global"],              "countries": ["global"],          "always_include": False},
    "ITA":  {"continent": "North America", "regions": ["us"],                  "countries": ["us"],              "always_include": False},
    "PAVE": {"continent": "North America", "regions": ["us"],                  "countries": ["us"],              "always_include": False},
    "UFO":  {"continent": "Global",        "regions": ["global"],              "countries": ["global"],          "always_include": False},
    "BNDX": {"continent": "International", "regions": ["global"],              "countries": ["global"],          "always_include": True},
    "EMB":  {"continent": "International", "regions": ["emerging_markets"],    "countries": ["emerging_markets"],"always_include": True},
    "DBA":  {"continent": "Global",        "regions": ["global"],              "countries": ["global"],          "always_include": True},
